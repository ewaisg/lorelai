...
For more information about creating deployments, see [Add and configure model deployments](../../model-inference/how-to/create-model-deployments).
...
For more information about how to use the **Azure OpenAI endpoint**, see [Azure OpenAI in Foundry Models documentation](../../openai/overview).
...
To use keyless authentication, [configure your resource and grant access to users](../../model-inference/how-to/configure-entra-id) to perform inference. After you configure the resource and grant access, authenticate as follows:
...
* [Foundry Models and capabilities](models)
* [Deployment types in Foundry Models](deployment-types)
* [What is Azure OpenAI in Foundry Models?](../../openai/overview)
